        ...
        .subscribe(
            (data) => {
                ...
                if (data.id) {
                    ...
                    this.store.dispatch(this.dispoManagerInstance.dispositionInstance.checkResolutionAction())
                    this.store.dispatch(this.dispoManagerInstance.dispositionInstance.checkCheckStatCountAction({record: data.orc_record.id}))
                }
            },
        );
    }
